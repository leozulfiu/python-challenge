...
cipher = '''kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
def getCandidates(input):
    return re.findall(r'[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]', input)

try:
    solution = []
    foundWords = getCandidates(cipher)
    for word in foundWords:
        solution.append(word[4])
    solution = ''.join(solution)
    url = 'http://www.pythonchallenge.com/pc/def/' + solution + '.html'
